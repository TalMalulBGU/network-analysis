...
def _main():
	...
	parser.add_argument('--alignment_score_rule', help='name of edge attribute', type=str, required=False, default='LE')
	parser.add_argument('--objective_function', help='name of edge attribute', type=str, required=False, default='modularity')
	parser.add_argument('--n_iterations', help='output file location', type=int, required=False, default=-1)
	...
	cluster_community_vc = ig_graph.community_leiden(weights=options.alignment_weight, objective_function=options.objective_function, n_iterations=options.n_iterations)
	quality = cluster_community_vc.quality
	qualities[options.alignment_score] = quality
	...
	result_dictionary[options.alignment_score] = {'quality': qualities[options.alignment_score],
							'n_vertices': n_vertices[options.alignment_score],
							'n_edges': n_edges[options.alignment_score],
							'n_clusters': n_clusters[options.alignment_score],
							'rule': options.alignment_score_rule,
