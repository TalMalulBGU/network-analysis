...
def _main():
	...
	algorithms_modularities = []
	clustering_dictionary_queue.append((algorithm, options.graph_name, 0, algorithms_modularities))

	while(len(clustering_dictionary_queue) > 0):
		algorithm, file_name, cluster_id, parent = clustering_dictionary_queue.pop()
		
		me = {'cluster_id': cluster_id, 'file_name': file_name, 'modularity': algorithm.modularity,
	...
	json_object = json.dumps(algorithms_modularities, indent = 4)
