...
def _main():
	...
	cc = graph.transitivity_local_undirected()
	weighted_cc = None
	
	if options.alignment_weight:
		weighted_cc = graph.transitivity_local_undirected(weights=options.alignment_weight)
	...
	for vertex in graph.vs:
		...
		result_dictionary[vertex['name']]['cc'] = cc[vertex.index]
		result_dictionary[vertex['name']]['neighbors_cc'] = []
		
		if options.alignment_weight:
			result_dictionary[vertex['name']]['weighted_cc'] = weighted_cc[vertex.index]
			result_dictionary[vertex['name']]['neighbors_weighted_cc'] = []
		
		for neighbor in vertex_neighbors:
			result_dictionary[vertex['name']]['neighbors_cc'].append(cc[neighbor])
			if options.alignment_weight:
				result_dictionary[vertex['name']]['neighbors_weighted_cc'].append(weighted_cc[neighbor])
