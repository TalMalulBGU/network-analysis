...
TEMPLATE_BATCH_FILE="/home/talmalu/thesis/projects/python/NetworkAnalysis/Scripts/template_batches/colored_taxonomy_degree_distribution_histogram_batch_template.sbatch"
