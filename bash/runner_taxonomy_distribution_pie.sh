...
TEMPLATE_BATCH_FILE="/home/talmalu/thesis/projects/python/NetworkAnalysis/Scripts/template_batches/taxonomy_distribution_pie_batch_template.sbatch"
...
sed -i "s/###TOP###/$TOP/g" $TMP_FILE_PATH
