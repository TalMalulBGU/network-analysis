...
TEMPLATE_BATCH_FILE="/home/talmalu/thesis/projects/python/NetworkAnalysis/Scripts/template_batches/clustering_coefficient_between_taxonomies_heatmap_batch_template.sbatch"
BATCH_RUNNER="/home/talmalu/thesis/projects/python/batch_runner.sh"

POSITIONAL_ARGS=()
CLUSTERING_COEFFICIENT_XLSX=""
TAXONOMY_LEVEL=""
XGMML_FILE=""
PROTEIN=""
OUTPUT=""
...
while [[ $# -gt 0 ]]; do
	...
	-f|--xgmml_file)
		...
		shift
	;;
	-c|--clustering_coefficient_xlsx)
		CLUSTERING_COEFFICIENT_XLSX=$2
		shift
		shift
    ;;
	-l|--taxonomy_level)
...
#echo "CLUSTERING_COEFFICIENT_XLSX = $ACTUAL_COUNT_XLSX"
...
sed -i "s~###CLUSTERING_COEFFICIENT_XLSX###~$CLUSTERING_COEFFICIENT_XLSX~g" $TMP_FILE_PATH
