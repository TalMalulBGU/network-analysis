...
TEMPLATE_BATCH_FILE="/home/talmalu/thesis/projects/python/NetworkAnalysis/Scripts/template_batches/filter_network_by_protein_sequence_length_batch_template.sbatch"
...
sed -i "s/###LIMIT###/${LIMIT[*]}/g" $TMP_FILE_PATH
