...
TEMPLATE_BATCH_FILE="/home/talmalu/thesis/projects/python/NetworkAnalysis/Scripts/template_batches/cluster_coefficients_alignment_score_decent_plot_batch_template.sbatch"
