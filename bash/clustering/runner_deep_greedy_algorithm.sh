...
TEMPLATE_BATCH_FILE="/home/talmalu/thesis/projects/python/NetworkAnalysis/Scripts/template_batches/clustering/deep_greedy_algorithm_batch_template.sbatch"
...
sed -i "s~###OUTPUT_FOLDER###~$OUTPUT_FOLDER~g" $TMP_FILE_PATH
