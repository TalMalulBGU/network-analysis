...
TEMPLATE_BATCH_FILE="/home/talmalu/thesis/projects/python/NetworkAnalysis/Scripts/template_batches/clustering/community_modularity_depth_batch_template.sbatch"
...
sed -i "s/###GRAPH_NAME###/$GRAPH_NAME/g" $TMP_FILE_PATH
sed -i "s~###OUT_FILE###~$OUT_FILE~g" $TMP_FILE_PATH
sed -i "s~###XGMML_FILE###~$XGMML_FILE~g" $TMP_FILE_PATH
sed -i "s~###DATA_FOLDER###~$DATA_FOLDER~g" $TMP_FILE_PATH
